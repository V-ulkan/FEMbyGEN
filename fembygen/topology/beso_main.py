...
def main(analysis):
    ...
    optimization_base = doc.Topology.optimization_base
    cpu_cores = doc.Topology.cpu_cores
    FI_violated_tolerance = doc.Topology.FI_violated_tolerance
    decay_coefficient = doc.Topology.decay_coefficient
    shells_as_composite = doc.Topology.shells_as_composite
    reference_points = doc.Topology.reference_points
    reference_value = doc.Topology.reference_value
    mass_addition_ratio = doc.Topology.mass_addition_ratio
    mass_removal_ratio = doc.Topology.mass_removal_ratio
    ratio_type = doc.Topology.ratio_type
    compensate_state_filter = doc.Topology.compensate_state_filter
    sensitivity_averaging = doc.Topology.sensitivity_averaging
    steps_superposition = doc.Topology.steps_superposition
    iterations_limit = doc.Topology.iterations_limit
    tolerance = doc.Topology.tolerance
    displacement_graph = doc.Topology.displacement_graph
    save_iteration_results = doc.Topology.save_iteration_results
    save_solver_files = doc.Topology.save_solver_files
    ...
    os.putenv('OMP_NUM_THREADS', str(doc.Topology.cpu_cores))
